    ...
    <div className="mt-12 flex flex-row gap-4">
      <div className="flex-1 leading-snug space-y-4 text-foreground/60 rounded-lg">
        <p>
          ...
          clean, responsive web apps — often blending development with design.
        </p>
        <p>
          I&apos;m passionate about learning fast, building things that people actually use,
          and creating experiences that feel intuitive and thoughtful.
        </p>
        <p>
