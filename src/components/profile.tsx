...
export default function Profile() {
  return (
    <div className="flex md:flex-row flex-col-reverse items-start justify-between md:items-center mt-12 pt-12">
      <div className="flex flex-col items-start justify-center gap-1">
        <h1 className="font-bold md:text-4xl text-xl text-primary">Bek Slambek</h1>
